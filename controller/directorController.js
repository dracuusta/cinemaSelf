...
exports.director_create_post=[
  ...
  asyncHandler(async(req,res,next)=>{
    ...
    const director=new Director({first_name:req.body.first_name,last_name:req.body.last_name,date_of_birth:req.body.date_of_birth,date_of_death:req.body.date_of_death})
    ...
    if(!errors.isEmpty()){
      ...
      /* Valid Form */
      const directorExists=await Director.find({first_name:req.body.first_name,last_name:req.body.last_name,date_of_birth:req.body.date_of_birth,date_of_death:req.body.date_of_death}).collation({locale:"en",strength:2});
